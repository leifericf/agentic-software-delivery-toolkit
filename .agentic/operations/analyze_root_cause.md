...
If `.agentic/artifacts/open_questions.md` exists, scan `## Open` and incorporate any resolved answers relevant to this RCA.
...
## Output Artifact
Write:
`.agentic/artifacts/operations/YYYY-MM-DD_root_cause_analysis-<incident_slug>.md`
