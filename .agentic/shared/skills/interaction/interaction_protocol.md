...
If a repo-local profile file exists at `.agentic/.agentic_profile.md`:
...
Interaction preferences are interpreted via `@.agentic/shared/skills/interaction/interaction_meta_preferences.md`.
...
- If `.agentic/artifacts/open_questions.md` exists, scan `## Open` for unanswered items.
...
Default mode:
- If `.agentic/.agentic_profile.md` exists, use its default question mode.
- Otherwise: Natural.
...
Follow the decision policy in `@.agentic/shared/skills/interaction/interaction_meta_preferences.md`.
...
- If the missing answer is required to proceed, add an unchecked `[Blocking]` item to `.agentic/artifacts/open_questions.md` and stop.
