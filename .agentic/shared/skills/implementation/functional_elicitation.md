...
- Ask only what you need. Cap at 1-2 short batches (max 3 questions per batch; respect user batch-size preference if set in `.agentic/.agentic_profile.md`).
...
If any item is unknown and blocks correct delivery, add it to `.agentic/artifacts/open_questions.md` as `[Blocking]` and stop.
