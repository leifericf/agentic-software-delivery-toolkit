...
See `@.agentic/shared/skills/gates/open_questions_gate.md` (Affects: `product_requirements.md`).

## Instructions
1. Review the Problem Description first.
2. Ask clarification questions where ambiguity exists.
3. Ask questions using the format in `@.agentic/shared/skills/interaction/questions_format.md`.
4. Identify contradictions.
5. Highlight assumptions.

When you identify unclear requirements, add them to `.agentic/artifacts/open_questions.md` under `## Open`.
...
> If yes, tag **@.agentic/planning/03_review_risks_assumptions.md**.”
